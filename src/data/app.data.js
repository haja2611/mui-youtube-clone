...
export const userProfileItems = [
  { id: 1, text: "Your Channel", icon: <BiUser size={24} /> },
  { id: 2, text: "Youtube Studio", icon: <SiYoutubestudio size={24} /> },
  {
    id: 3,
    text: "Switch Account",
    icon: <FiUsers size={24} />,
  },
  { id: 4, text: "Sign out", icon: <VscSignOut size={24} /> },
  { id: 5, divider: true },
  {
    id: 6,
    text: "Purchase & Membership",
    icon: <MdOutlineMonetizationOn size={24} />,
  },
  {
    id: 7,
...

  {
    ...
    icon: <MdOutlineModeNight size={24} />,
  },
  { id: 10, text: "Language:English", icon: <HiOutlineLanguage size={24} /> },
  {
    id: 11,
    text: "Restricted Mode: Off",
    icon: <MdOutlineAdminPanelSettings size={24} />,
  },
  { id: 12, text: "Location:India", icon: <MdLanguage size={24} /> },
  {
    id: 13,
  ...
  { id: 18, text: "Send feedback", icon: <MdOutlineFeedback size={24} /> },
];

export const uploadMenuItems = [
  { id: 1, icon: <RxVideo />, text: "Upload Video" },
  { id: 2, icon: <FiRadio />, text: "Go Live" },
  { id: 3, text: "Create post", icon: <SlNote /> },
];
